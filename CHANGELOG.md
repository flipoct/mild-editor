...
- Language marks. The `C++` and `Py` badges beside a filename are now the official C++ and Python logos, from [Simple Icons](https://simpleicons.org) under CC0, tinted by the theme.
