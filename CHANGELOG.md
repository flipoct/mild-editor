...
- Language marks. The `C++` and `Py` badges beside a filename are now the C++ and Python logos as line art, from [Tabler Icons](https://tabler.io/icons) under MIT, in the theme's own language colours.
