...
- The problem panel, the panel chips and the layout popover follow the selected theme. They had shipped with their own fixed greys, so a light theme left a dark toolbar and popover.
